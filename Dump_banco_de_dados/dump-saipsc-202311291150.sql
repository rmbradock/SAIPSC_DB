...
INSERT INTO `acesso` VALUES (1,'ADM','Professor'),(3,'OUTROs','Aluno2'),(4,'Colaborador','teste1');
...
INSERT INTO `aluno` VALUES (1,1,1,'1975-11-29','47','ricardo',NULL,NULL,NULL,2,NULL),(2,2,1,'1975-11-29','47','sara','2023-01-01','2023-01-02','0',1,'123123456.6'),(4,3,2,'1979-05-16','42','sara','2023-01-01','2023-01-01','15',2,'123456');
...
INSERT INTO `campeonato` VALUES (1,'Copa Semeando Campeoes','Campo Mourao','Ricardo','44998130695','2023-12-16','50,00'),(2,'Copa amizade','Umuarama','Wander','123','2023-01-01','100');
...
INSERT INTO `cargo` VALUES (1,'Professor Senior',NULL),(2,'Professor','1'),(3,'Instrutor Senior',NULL),(4,'Instrutor',NULL),(5,'Banana','11');
...
INSERT INTO `categoriakf` VALUES (1,'Kimono'),(2,'Faixa'),(4,'Kimono Infantil1'),(5,'Kimono adulto');
...
INSERT INTO `cor` VALUES (1,'branca'),(2,'cinza com branco'),(3,'Verde com Preto'),(4,'Preta'),(5,'marrom'),(6,'Marrom'),(7,'banana');
...
INSERT INTO `equipe` VALUES ('1',1,1,1,'2023-07-27','00',1),('2',1,1,3,'2023-01-01','5001',3);
...
--
-- Table structure for table `kimonof`
--

DROP TABLE IF EXISTS `kimonof`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kimonof` (
  `id` int NOT NULL,
  `quantidade` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
--
-- Dumping data for table `kimonof`
--

LOCK TABLES `kimonof` WRITE;
/*!40000 ALTER TABLE `kimonof` DISABLE KEYS */;
INSERT INTO `kimonof` VALUES (1,NULL,1,1,1,1,1),(2,'2',1,1,1,1,1),(3,'2',2,2,2,1,2);
/*!40000 ALTER TABLE `kimonof` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `participacao` VALUES (1,'4',1,1),(2,'2',1,2),(3,'4',1,4);
...
INSERT INTO `patrimonio` VALUES (1,'Tatame','20','proprio','comprado'),(2,'Anilha','3','comodato','ricardob');
...
INSERT INTO `pessoa` VALUES (1,'Ricardo','62424796','02046234995','rua akibono','44998130695','B','ricardo','1234',''),(2,'Teste','12345678','123456789','teste end','4444444','A','teste','123','Masculino'),(3,'banana','2315','445522','tasta',NULL,NULL,'123','123',''),(4,'Eduardo','123','123','123','123','1222	','123','123','M'),(5,'Eduardo','123','123','123','123','bana','124','123','M');
...
INSERT INTO `polos` VALUES (1,'CT Centro','R. São Josafat, 1778','Pastor Gustavo','',NULL),(2,'ACAO KIDS','','','','');
...
CREATE TABLE `tamanho` (
  `id` int NOT NULL,
  `tam` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `descricao` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tamanho` VALUES (1,'M0','1'),(2,'M1','1');
...
-- Dump completed on 2023-11-29 11:50:23
