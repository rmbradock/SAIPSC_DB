...
public class DaoEquipe extends BancoDeDadosMySql{
    ...
    public Boolean inserir(int id, int idPessoa, int idCargo, int idCor, String graduacao, String salario, int idAcesso){
        try{
            ...
            getStatement().setString(5, graduacao);
    ...
    public Boolean alterar(int id, int idPessoa, int idCargo, int idCor, String graduacao, String salario, int idAcesso){
        try{
            ...
            getStatement().setString(4, graduacao);
    ...
    public ResultSet listarPorAcesso(String acesso){
        try{
            ...
            getStatement().setString(1, acesso + "%");
