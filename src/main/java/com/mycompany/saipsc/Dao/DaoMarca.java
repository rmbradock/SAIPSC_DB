...
public class DaoMarca extends BancoDeDadosMySql{
    private String sql;
        public Boolean inserir(int id, String nome, String descricao){
                try{
                    sql = "INSERT INTO MARCA (ID, NOME, DESCRICAO) VALUES (?,?,?)";
            ...
            public Boolean alterar(int id, String novoNome, String novaDescricao){
                try{
                    sql = "UPDATE MARCA SET NOME = ?, DESCRICAO = ? WHERE ID = ?";
            ...
            public ResultSet listarTodos(){
                try{
                    sql = "SELECT ID, NOME, IFNULL(DESCRICAO, '') FROM MARCA";
            ...
            public ResultSet listarPorId(int id){
                try{
                    sql = "SELECT ID, NOME, IFNULL(DESCRICAO, '') FROM MARCA WHERE ID = ?";
            ...
            public ResultSet listarPorNome(String nome){
                try{
                    sql = "SELECT ID, NOME, IFNULL(DESCRICAO, '') FROM MARCA WHERE NOME LIKE ?";
            ...
            public ResultSet listarPorDescricao(String descricao){
                try{
                    sql = "SELECT ID, NOME, IFNULL(DESCRICAO, '') FROM MARCA WHERE DESCRICAO LIKE ?";
