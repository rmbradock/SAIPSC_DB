 ...
 * @author Batista
 */
public class CadCor extends javax.swing.JFrame {

    /**
     * Creates new form CadCor
     */
    public CadCor() {
        initComponents();
    if(!existeDadosTemporarios()){
        ...
        private Boolean existeDadosTemporarios(){        
            if(DadosTemporarios.tempObject instanceof ModCor){
                int id = ((ModCor) DadosTemporarios.tempObject).getId();
                String descricao = ((ModCor) DadosTemporarios.tempObject).getDescricao();
        ...
        private void inserir(){
            ...
            if (daoCor.inserir(Integer.parseInt(tfId.getText()), taDescricao.getText())){
                JOptionPane.showMessageDialog(null, "Cor salva com sucesso!");

                tfId.setText(String.valueOf(daoCor.buscarProximoId()));
                taDescricao.setText("");
            }else{
                JOptionPane.showMessageDialog(null, "Não foi possível salvar a Cor!");
            }
        }
        ...
        private void alterar(){
            ...
            if (daoCor.alterar(Integer.parseInt(tfId.getText()), taDescricao.getText())){
            ...
            ((ListCor) Formularios.listCor).listarTodos();
        ...
        private void excluir(){
            ...
            if (daoCor.excluir(Integer.parseInt(tfId.getText()))){
                JOptionPane.showMessageDialog(null, "Cor " + taDescricao.getText() + " excluída com sucesso!");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        JOptionPane.showConfirmDialog(
            null,
            "Deseja realmente excluir a Cor " + taDescricao.getText() + "?");
