 ...
 * @author Batista
 */
public class CadCategoriaU extends javax.swing.JFrame {

    /**
     * Creates new form CadCategoria
     */
    public CadCategoriaU() {
        initComponents();
        ...
        private Boolean existeDadosTemporarios(){        
            if(DadosTemporarios.tempObject instanceof ModCategoriaU){
                int id = ((ModCategoriaU) DadosTemporarios.tempObject).getId();
                String nome = ((ModCategoriaU) DadosTemporarios.tempObject).getNome();
        ...
        private void alterar(){
            ...
            ((ListCategoriaU) Formularios.listCategoriaKF).listarTodos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadCategoriaU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadCategoriaU().setVisible(true);
            }
        });
    }
